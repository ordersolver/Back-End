...
Rails.application.routes.draw do
  ...
  get "user_total_orders_pdf" => "user_statistics#numOfOrdersPdf"
  get "user_spent_money_pdf" => "user_statistics#spentMoneyPdf"
  get "user_most_sold_pdf" => "user_statistics#mostSoldPdf"
  resources :users
